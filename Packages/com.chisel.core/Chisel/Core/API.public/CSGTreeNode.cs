...
namespace Chisel.Core
{
    ...
    public partial struct CSGTreeNode 
    {
        ...
        public bool				Valid			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return nodeID != CSGTreeNode.InvalidNodeID && CSGTreeNode.IsNodeIDValid(nodeID); } }
        ...
        public Int32			NodeID			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return nodeID; } }
        ...
        public Int32			UserID			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return CSGTreeNode.GetUserIDOfNode(nodeID); } }

        /// <value>Returns the dirty flag of the <see cref="Chisel.Core.CSGTreeNode"/>.</value>
        public bool				Dirty			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return CSGTreeNode.IsNodeDirty(nodeID); } }
        ...
        public CSGTreeBranch	Parent			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return new CSGTreeBranch { branchNodeID = CSGTreeNode.GetParentOfNode(nodeID) }; } }

        /// <value>Returns tree this <see cref="Chisel.Core.CSGTreeNode"/> belongs to.</value>
        public CSGTree			Tree			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return new CSGTree		 { treeNodeID   = CSGTreeNode.GetTreeOfNode(nodeID)  }; } }
        ...
        public CSGOperationType Operation		{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return (CSGOperationType)GetNodeOperationType(nodeID); } [MethodImpl(MethodImplOptions.AggressiveInlining)] set { SetNodeOperationType(nodeID, value); } }
        #endregion

        #region ChildNodeContainer
        /// <value>Gets the number of elements contained in the <see cref="Chisel.Core.CSGTreeBranch"/>.</value>
        public Int32			Count			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return CSGTreeNode.GetChildNodeCount(nodeID); } }

        /// <summary>Gets child at the specified index.</summary>
        /// <param name="index">The zero-based index of the child to get.</param>
        /// <returns>The element at the specified index.</returns>
        public CSGTreeNode		this[int index]	{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return new CSGTreeNode { nodeID = CSGTreeNode.GetChildNodeAtIndex(nodeID, index) }; } }
        ...
        public CSGNodeType		Type				  { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return CSGTreeNode.GetTypeOfNode(nodeID); } }
        ...
        public Matrix4x4			LocalTransformation		{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetNodeLocalTransformation(nodeID); } [MethodImpl(MethodImplOptions.AggressiveInlining)] set { SetNodeLocalTransformation(nodeID, ref value); } }		
        // TODO: add description
        public Matrix4x4			TreeToNodeSpaceMatrix   { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { if (!CSGManager.GetTreeToNodeSpaceMatrix(nodeID, out Matrix4x4 result)) return Matrix4x4.identity; return result; } }
        // TODO: add description
        public Matrix4x4			NodeToTreeSpaceMatrix	{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { if (!CSGManager.GetNodeToTreeSpaceMatrix(nodeID, out Matrix4x4 result)) return Matrix4x4.identity; return result; } }
        #endregion
