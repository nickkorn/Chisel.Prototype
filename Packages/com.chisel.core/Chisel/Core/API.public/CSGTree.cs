...
namespace Chisel.Core
{
    ...
    public partial struct CSGTree
    {
        ...
        public bool				Valid			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return treeNodeID != CSGTreeNode.InvalidNodeID && CSGTreeNode.IsNodeIDValid(treeNodeID); } }
        ...
        public Int32			NodeID			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return treeNodeID; } }

        /// <value>Gets the <see cref="Chisel.Core.CSGTree.UserID"/> set to the <see cref="Chisel.Core.CSGTree"/> at creation time.</value>
        public Int32			UserID			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return CSGTreeNode.GetUserIDOfNode(treeNodeID); } }
        ...
        public bool				Dirty			{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return CSGTreeNode.IsNodeDirty(treeNodeID); } }
