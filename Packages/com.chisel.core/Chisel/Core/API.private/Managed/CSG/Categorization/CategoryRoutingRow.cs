...
namespace Chisel.Core
{
    ...
    internal unsafe struct CategoryRoutingRow
    {
        ...
        public readonly static CategoryRoutingRow aligned   = new CategoryRoutingRow(CategoryIndex.Aligned, CategoryIndex.Aligned, CategoryIndex.Aligned, CategoryIndex.Aligned);
