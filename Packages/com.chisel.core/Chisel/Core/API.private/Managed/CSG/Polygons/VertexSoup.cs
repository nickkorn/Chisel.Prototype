...
namespace Chisel.Core
{
    ...
    internal static class VertexSoupUtility
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe static ushort Add(ref NativeArray<int> hashTable, ref NativeList<VertexSoup.ChainedIndex> chainedIndices, ref NativeList<float3> vertices, float3 vertex)
        {
            ...
            // Add Unique vertex
            {
                ...
                var newChainedIndex = new VertexSoup.ChainedIndex() { vertexIndex = vertexIndex, nextChainIndex = prevChainIndex };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe static ushort AddNoResize(ref NativeArray<int> hashTable, ref NativeList<VertexSoup.ChainedIndex> chainedIndices, ref NativeList<float3> vertices, float3 vertex)
        {
            var centerIndex = new int3((int)(vertex.x / VertexSoup.kCellSize), (int)(vertex.y / VertexSoup.kCellSize), (int)(vertex.z / VertexSoup.kCellSize));
            var offsets = stackalloc int3[]
            {
    ...
    public struct VertexSoup : IDisposable
    {
        ...
        {
            return VertexSoupUtility.Add(ref hashTable, ref chainedIndices, ref vertices, vertex);
        }
