...
#if false
    [TestFixture]
    public partial class SubtractLoopTests
    {
        const string sourceFilename         = @"Packages\com.chisel.core.tests\Chisel\Core\Tests\LoopTests\Subtractive\{0}.prefab";
//      const string destinationPath        = @"Assets\LoopTests\Subtractive\";
//      const string destinationFilename    = destinationPath + @"{0}.unity";
        ...
        static CaseDetails[] cases = new[]
        {
            ...
            new CaseDetails() { sceneName = "case_2",  expectedVertexCounts = new [] { 4, 4 } },
            new CaseDetails() { sceneName = "case_3",  expectedVertexCounts = new [] { 3, 3, 3, 3 } },
            new CaseDetails() { sceneName = "case_4",  expectedVertexCounts = new [] { 3, 3, 3, 3 } },
            new CaseDetails() { sceneName = "case_5",  expectedVertexCounts = new [] { 4, 4 } },
            new CaseDetails() { sceneName = "case_6",  expectedVertexCounts = new int[] { } },
            new CaseDetails() { sceneName = "case_7",  expectedVertexCounts = new int[] { } },
            new CaseDetails() { sceneName = "case_8",  expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_9",  expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_10", expectedVertexCounts = new [] { 5 } },
            new CaseDetails() { sceneName = "case_11", expectedVertexCounts = new [] { 4 } },
            new CaseDetails() { sceneName = "case_12", expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_13", expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_14", expectedVertexCounts = new [] { 8 } },
            new CaseDetails() { sceneName = "case_15", expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_16", expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_17", expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_18", expectedVertexCounts = new [] { 6 } },
            new CaseDetails() { sceneName = "case_19", expectedVertexCounts = new [] { 10 } },
            new CaseDetails() { sceneName = "case_20", expectedVertexCounts = new [] { 12 } },
            new CaseDetails() { sceneName = "case_21", expectedVertexCounts = new [] { 4, 8 } },
            new CaseDetails() { sceneName = "case_22", expectedVertexCounts = new [] { 10 } },
            new CaseDetails() { sceneName = "case_23", expectedVertexCounts = new [] { 12 } },
            new CaseDetails() { sceneName = "case_24", expectedVertexCounts = new [] { 8 } },
            new CaseDetails() { sceneName = "case_25", expectedVertexCounts = new [] { 7 } },
            new CaseDetails() { sceneName = "case_26", expectedVertexCounts = new [] { 8 } },
            new CaseDetails() { sceneName = "case_27", expectedVertexCounts = new [] { 3 } }
        };
